...
# Remove the old toggle block
old_toggle = """                <div style={{ marginTop: '20px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <input 
                    type="checkbox" 
                    id="disableBg" 
...
print("Moved the toggle to the theme section")
